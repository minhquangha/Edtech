import {} from "express";
import {} from "@/types/assignments.js";
...
const AssignmentController = {
    create: async (req, res) => {
        ...
        try {
            ...
            const assignment = await AssignmentService.create(assignmentReq, teacherId);
    ...
    update: async (req, res) => {
        try {
            ...
            await AssignmentService.updateAssignment(assignmentId, teacherId, assignment);
            return res.status(200).json({
